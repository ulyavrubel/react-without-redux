...
var MegaMenu = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MegaMenu, [{
    ...
    value: function renderSubmenuIcon(item) {
      if (item.items) {
        var className = (0, _classnames.default)('p-submenu-icon pi', {
    ...
    value: function renderSubmenuItem(item, index) {
      ...
      if (item.separator) {
        ...
        var linkClassName = (0, _classnames.default)('p-menuitem-link', {
    ...
    value: function renderSubmenu(submenu) {
      ...
      var className = (0, _classnames.default)('p-megamenu-submenu-header', {
    ...
    value: function renderCategory(category, index) {
      ...
      var iconClassName = (0, _classnames.default)('p-menuitem-icon', category.icon);
