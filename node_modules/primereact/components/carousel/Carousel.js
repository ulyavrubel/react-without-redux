...
var Carousel = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(Carousel, [{
    ...
    value: function renderBackwardNavigator() {
      ...
      var buttonClassName = (0, _classnames.default)('p-carousel-prev p-link', {
    ...
    value: function renderForwardNavigator() {
      ...
      var buttonClassName = (0, _classnames.default)('p-carousel-next p-link', {
        'p-disabled': isDisabled
      }),
    ...
    value: function renderIndicator(index) {
      ...
      var isActive = this.getPage() === index,
          indicatorItemClassName = (0, _classnames.default)('p-carousel-indicator', {
    ...
    value: function renderIndicators() {
      var indicatorsContentClassName = (0, _classnames.default)('p-carousel-indicators p-reset', this.props.indicatorsContentClassName);
      var indicators = [];
