  ...
  _createClass(Password, [{
    ...
    value: function onFocus(e) {
      ...
      if (this.props.feedback) {
        ...
        setTimeout(function () {
          _DomHandler.default.addClass(_this2.panel, 'p-connected-overlay-visible');

          _DomHandler.default.removeClass(_this2.panel, 'p-connected-overlay-hidden');
        }, 1);
    ...
    value: function onBlur(e) {
      ...
      if (this.props.feedback) {
        _DomHandler.default.addClass(this.panel, 'p-connected-overlay-hidden');

        _DomHandler.default.removeClass(this.panel, 'p-connected-overlay-visible');

        setTimeout(function () {
          _this3.panel.style.display = 'none';

          _DomHandler.default.removeClass(_this3.panel, 'p-connected-overlay-hidden');
        }, 150);
      }
