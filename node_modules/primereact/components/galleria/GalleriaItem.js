...
var GalleriaItem = /*#__PURE__*/function (_Component) {
  _inherits(GalleriaItem, _Component);

  var _super = _createSuper(GalleriaItem);

  function GalleriaItem(props) {
    var _this;
  ...
  _createClass(GalleriaItem, [{
    ...
    value: function renderBackwardNavigator() {
      if (this.props.showItemNavigators) {
        ...
        var buttonClassName = (0, _classnames.default)('p-galleria-item-prev p-galleria-item-nav p-link', {
    ...
    value: function renderForwardNavigator() {
      if (this.props.showItemNavigators) {
        ...
        var buttonClassName = (0, _classnames.default)('p-galleria-item-next p-galleria-item-nav p-link', {
          'p-disabled': isDisabled
        });
        return /*#__PURE__*/_react.default.createElement("button", {
          type: "button",
    ...
    value: function renderIndicator(index) {
      ...
      var indicatorItemClassName = (0, _classnames.default)('p-galleria-indicator', {
    ...
    value: function renderIndicators() {
      if (this.props.showIndicators) {
        var indicatorsContentClassName = (0, _classnames.default)('p-galleria-indicators p-reset', this.props.indicatorsContentClassName);
        var indicators = [];
