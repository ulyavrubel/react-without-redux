...
function tip(props) {
  ...
  return {
    destroy: function destroy() {
      ...
      _DomHandler.default.removeChild(tooltipWrapper, appendTo);
    },
...
var Tooltip = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.state.visible && prevProps.content !== this.props.content) {
        this.applyDelay('updateDelay', function () {
          _this7.updateText(_this7.currentTarget, function () {
            _this7.align(_this7.currentTarget);
          });
        });
      }
    }
    ...
    value: function renderElement() {
      ...
      var tooltipClass = (0, _classnames.default)('p-tooltip p-component', _defineProperty({}, "p-tooltip-".concat(this.state.position), true), this.props.className);
      return /*#__PURE__*/_react.default.createElement("div", {
        ref: function ref(el) {
          return _this8.containerEl = el;
        },
        ...
        ref: function ref(el) {
          return _this8.tooltipTextEl = el;
        },
...
_defineProperty(Tooltip, "propTypes", {
  ...
  onBeforeUpdated: _propTypes.default.func,
