...
var Accordion = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(Accordion, [{
    ...
    value: function renderTabHeader(tab, selected, index) {
      ...
      var tabHeaderClass = (0, _classnames.default)('p-accordion-header', {
        'p-highlight': selected,
        'p-disabled': tab.props.disabled
      }, tab.props.headerClassName);
      var iconClassName = (0, _classnames.default)('p-accordion-toggle-icon pi', {
        'pi-chevron-right': !selected,
        'pi-chevron-down': selected
      });
    ...
    value: function renderTabContent(tab, selected, index) {
      var className = (0, _classnames.default)('p-toggleable-content', tab.props.contentClassName);
    ...
    value: function renderTab(tab, index) {
      ...
      var tabClassName = (0, _classnames.default)('p-accordion-tab', {
    ...
    value: function render() {
      ...
      var className = (0, _classnames.default)('p-accordion p-component', this.props.className);
