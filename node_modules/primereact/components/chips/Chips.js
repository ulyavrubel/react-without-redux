...
var Chips = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Chips, [{
    ...
    value: function renderList() {
      ...
      var className = (0, _classnames.default)('p-inputtext p-chips-multiple-container', {
    ...
    value: function render() {
      ...
      var className = (0, _classnames.default)('p-chips p-component', this.props.className, {
        'p-inputwrapper-filled': this.props.value && this.props.value.length > 0 || _DomHandler.default.hasClass(this.inputElement, 'p-filled') && this.inputElement.value !== '',
