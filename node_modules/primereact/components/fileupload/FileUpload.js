...
var FileUpload = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function renderChooseButton() {
      ...
      var className = (0, _classnames.default)('p-button p-fileupload-choose p-component', {
      ...
      }, this.props.chooseLabel), /*#__PURE__*/_react.default.createElement(_Ripple.Ripple, null));
    }
  }, {
    key: "renderFiles",
    ...
    value: function renderAdvanced() {
      ...
      var className = (0, _classnames.default)('p-fileupload p-fileupload-advanced p-component', this.props.className);
    ...
    value: function renderBasic() {
      ...
      var className = (0, _classnames.default)('p-fileupload p-fileupload-basic p-component', this.props.className);
      var buttonClassName = (0, _classnames.default)('p-button p-component p-fileupload-choose', {
        'p-fileupload-choose-selected': this.hasFiles(),
        'p-disabled': this.props.disabled,
        'p-focus': this.state.focused
      });
      var iconClassName = (0, _classnames.default)('p-button-icon p-button-icon-left pi', {
        'pi-plus': !this.hasFiles() || this.props.auto,
        'pi-upload': this.hasFiles() && !this.props.auto
      });
      var label = this.props.auto ? this.props.chooseLabel : this.hasFiles() ? this.state.files[0].name : this.props.chooseLabel;
      return /*#__PURE__*/_react.default.createElement("div", {
        className: className
